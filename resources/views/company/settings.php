...
<!-- <h1>Users' List</h1> -->
	...
	<div class="grid mobile">
		<div class="column column-8">
				...
				<label style="font-size: 20px;">Allow SMS?</label> 
				<br />
				<label class="switch">  
				   <input type="checkbox" name="showsorting"  <?php if($this->data->allow_sms=="YES"): echo "Checked"; endif; ?> id="showDiscount">
				...
				<input type="text" name="org_num" id="org_num" class="form-control" value="<?=$this->data->pageCount?>">
				</div>
