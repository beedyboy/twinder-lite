...
<div class="alert ">
  ...
  <form action="<?=base_url.'role/edit/'.$this->data->id; ?>" method="post"  role="form">
...
<div class="form-group">
<label><input type="checkbox" id="roleAll" name="roleAll" value="*"  <?php if(!empty($permissions['Role']) && (in_array("*", $permissions['Role']))):  echo "checked"; endif; ?>  /> Roles</label> 
 
  <label for="rolecreate" class="beedy-check">Create
 <input type="checkbox" name="role[]" value="c" class="roleCase" id="rolecreate"  <?php if(!empty($permissions['Role']) && (in_array("*", $permissions['Role']) || in_array("c",  $permissions['Role']))):  echo "checked"; endif; ?>> 
   <span class="checkmark"></span>
   </label>

<label for="roleread" class="beedy-check">Read
 <input type="checkbox" name="role[]" value="r" class="roleCase" id="roleread"  <?php if(!empty($permissions['Role']) && (in_array("*", $permissions['Role']) || in_array("r",  $permissions['Role']))):  echo "checked"; endif; ?>> 
   <span class="checkmark"></span>
   </label>

 <label for="roleupdate" class="beedy-check">Update
 <input type="checkbox" name="role[]" value="u" class="roleCase" id="roleupdate"  <?php if(in_array("*", $permissions['Role']) || in_array("u",  $permissions['Role'])):  echo "checked"; endif; ?>> 
 <span class="checkmark"></span>
 </label> 
